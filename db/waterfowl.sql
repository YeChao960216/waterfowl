...
CREATE TABLE `aquaculture` (
  ...
  `remark` varchar(200) DEFAULT NULL COMMENT '厂家',
...
INSERT INTO `dictionary` VALUES ('2001', '冷藏', '2000', 'mode');
...
-- Records of material
-- ----------------------------
INSERT INTO `material` VALUES ('1', '2017-11-19 21:59:11', '81消毒液', '2017-12-02 21:18:34', '1', '123', '1', '0', '1', '0', '1', '1', '1', '\'未过期\'');
...
CREATE TABLE `outstorage` (
  ...
  `remark` varchar(200) DEFAULT NULL COMMENT '产家',
  ...
  `id_recorder` varchar(45) DEFAULT NULL COMMENT '记录者编号',
  `id_charge` varchar(45) DEFAULT NULL COMMENT '负责人编号',
  PRIMARY KEY (`id_outstorage`,`record_date`),
  KEY `fk_storage_user1_idx` (`id_recorder`),
  KEY `fk_storage_user2_idx` (`id_charge`),
